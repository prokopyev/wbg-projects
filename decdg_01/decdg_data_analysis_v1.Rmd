...
p <- ggplot(data_wdi_2015,aes(SP.DYN.LE00.MA.IN, SP.DYN.LE00.FE.IN, SP.POP.TOTL, 
          ...
          # Create text captions for countries with 180M+ populations
            geom_text_repel( 
                    aes(label=ifelse(
                    SP.POP.TOTL>126000000, # Caption only top-10 countries by population
