...
#   summarize(delin_int_2017)
# 
# data_census_chunk$delin_int_2017[data_census_chunk$census_tract==130260305120050]
# 
...
labels <- sprintf(
  "<strong>Census tract ID: %s</strong><br/>num_properties: %s <br/>delin_int_2004: %s <br/>delin_int_2005: %s<br/>delin_int_2006: %s",
  shp_manaus_edit@data$CD_GEOCODI, 
  round(shp_manaus_edit@data$num_properties, digits = 4),
  round(shp_manaus_edit@data$delin_int_2004, digits = 4),
  round(shp_manaus_edit@data$delin_int_2005, digits = 4),
  round(shp_manaus_edit@data$delin_int_2006, digits = 4),
  big.mark = " ") %>% lapply(htmltools::HTML)


# Create a continuous palette function
palette_1 <- colorNumeric(palette = "Blues", domain = shp_manaus_edit@data$num_properties)
palette_2 <- colorNumeric(palette = "Oranges", domain = shp_manaus_edit@data$delin_int_2004)
palette_3 <- colorNumeric(palette = "Oranges", domain = shp_manaus_edit@data$delin_int_2005)
palette_4 <- colorNumeric(palette = "Oranges", domain = shp_manaus_edit@data$delin_int_2006)
...
lft <- leaflet(shp_manaus_edit) %>%
  ...
  addPolygons(color = "#232a35", weight = 1, smoothFactor = 1,
             ...
             fillColor = ~palette_2(delin_int_2004),
              highlightOptions = highlightOptions(color = "white", weight = 2,
                                                  bringToFront = TRUE),
              label = labels,
              labelOptions = labelOptions(
                ...
                textsize = "15px",
                direction = "auto")
           , group = "delin_int_2004"
              )  %>%
  addPolygons(color = "#232a35", weight = 1, smoothFactor = 1,
              opacity = 1.0, fillOpacity = 0.7,
              fillColor = ~palette_3(delin_int_2005),
              highlightOptions = highlightOptions(color = "white", weight = 2,
                                                  bringToFront = TRUE),
              label = labels,
              labelOptions = labelOptions(
                ...
                textsize = "15px",
                direction = "auto"),
              group = "delin_int_2005")  %>%
  addPolygons(color = "#232a35", weight = 1, smoothFactor = 1,
              opacity = 1.0, fillOpacity = 0.7,
             fillColor = ~palette_4(delin_int_2006),
              highlightOptions = highlightOptions(color = "white", weight = 2,
                                                  bringToFront = TRUE),
              label = labels,
              labelOptions = labelOptions(
                ...
                textsize = "15px",
                direction = "auto")
             , group = "delin_int_2006"
             )   %>%
  # Add Legends
    addLegend(values = shp_manaus_edit@data$num_properties, group = "num_properties", pal = palette_1,
              position = "bottomleft") %>%
    addLegend(values = shp_manaus_edit@data$delin_int_2004, group = "delin_int_2014", pal = palette_2,
              position = "bottomleft") %>%
    # addLegend(values = shp_manaus_edit@data$delin_int_2005, group = "delin_int_2015", pal = palette_3,
    #           position = "bottomleft") %>%
    # addLegend(values = shp_manaus_edit@data$delin_int_2006, group = "delin_int_2016", pal = palette_4,
    #           position = "bottomleft") %>%
  #  Layers control
  addLayersControl(
